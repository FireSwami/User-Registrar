...
class Visitors(models.Model):
    ...
    last_name = models.CharField(max_length=100, help_text='Ivanov', verbose_name="Фамилия")
    ...
    class Meta:
        constraints = [models.UniqueConstraint(fields=['first_name', 'last_name'], name='unique_together')]
